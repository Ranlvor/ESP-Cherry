...
mountingHoleSize = 3; //hole in board is 3.2
...
module mountingHole(x,y, hole="M5") {
    translate([x,y,5]) hole_threaded(name=hole, l=10);
}
module upperPart() {   
    keyHoleSize = 19;
...
difference() {
    ...
    translate([0,0, boardZ]) cube([boardX+xExtraSpace, boardY, buttonToUserPannel+delta]);
